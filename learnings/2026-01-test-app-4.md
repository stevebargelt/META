...
Crash occurred after step 3 completed but before `handoff_merge_step()` ran. The `.meta/handoff-step-3.md` file exists with full content but wasn't appended to main handoff.
...
Currently `.meta/handoff-step-N.md` files remain after merge. Options:
- Delete after merge
